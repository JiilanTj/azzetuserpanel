    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-sm text-(--gray-10) max-w-lg mx-auto">
          Dapatkan akses penuh ke fitur akuntansi B2B tercanggih yang didesain
          untuk mendorong performa bisnis Anda.
        </p>
      </div>
        ...
        {plans?.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={cn(
                "relative flex flex-col p-8 rounded-2xl border bg-surface transition-all duration-300 hover:shadow-lg",
                isCurrentPlan
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-lg font-bold text-(--gray-12) mb-1">
                  {plan.name}
                </h3>
                <p className="text-xs text-(--gray-10) min-h-8">
                  {plan.description || `Fitur dasar untuk plan ${plan.name}`}
                </p>
                <div className="mt-4 flex items-baseline">
                  ...
                  {plan.price_monthly > 0 && (
                    <span className="ml-1 text-xs text-(--gray-10)">
                      / bulan
                    </span>
                  )}
                </div>
              ...
              <div className="flex-1 mb-8">
                <p className="text-xs font-semibold text-(--gray-12) mb-4 uppercase tracking-wider">
                  Fitur Termasuk:
                </p>
